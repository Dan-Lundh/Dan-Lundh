...
* AI Application using [speech to text](https://github.com/Dan-Lundh/speech2text-cmd) (fairly realtime), with sample of voice commands to control the app.The app takes the input and finds similar projects (using a chromaDB with faiss), filtered using selective information, to be sent of to Google Gemini (LLM). 
